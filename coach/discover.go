 ...
 */
func DiscoverCurrentUser(settings *handler_local.Settings) error {
 ...
 */
func DiscoverUserPaths(settings *handler_local.Settings) error {
	var err error
 ...
 */
func DiscoverProjectPaths(settings *handler_local.Settings) error {
 ...
 *
 */
func DiscoverEnvironmentPath(settings *handler_local.Settings, environment string) error {
